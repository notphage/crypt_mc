...
//#include "sdk.h"
//
//class c_block_18X : public c_block
//{
//public:
//	void instantiate(jobject, JNIEnv*) override;
//};
//
//class c_class_loader_18X : public c_class_loader
//{
//public:
...
//};
//
//class c_player_18X : public c_player
//{
//public:
//	void instantiate(jobject, JNIEnv*) override;
//
...
//    jboolean is_potion_active(jint potion);
//
...
//    void set_step_height(jfloat) override;
...
//};
//
//class c_world_18X : public c_world
//{
//public:
//	void instantiate(jobject, JNIEnv*) override;
...
//	void set_object_mouse_over(jobject moving) override;
