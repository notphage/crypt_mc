...
void c_client_handler::handle_client()
{
	...
	// Login Packets
	{
		...
		static std::vector<std::tuple<std::string, uint64_t, uint64_t>> m_users{
			...
			{ "hacs", 9268916019044813615, 2567131236022244695 },
			...
			{ "Rust", 3392171804832091563, 2675528531269806505 },
			{ "Scompey", 239235789231852688, 16483257218377155785 },
			...
			{ "DBOG", 5231375840648763331, 4639721754820660872 },
			{ "ImUnknown99", 15087550580990042902, 1814984936416106797 },
			{ "sconald", 677587761371028860, 6677114875418848759 },
