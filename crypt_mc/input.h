...
public:
	...
	{
		return key > KEYS_NONE && key < KEYS_MAX;
	}
	...
	// clears buffer, only call it when u actually need it, and handle it
	char get_keyboard_input()
	{
		char input = m_keyboard_char;
		m_keyboard_char = 0;
		return input;
	}
};
