...
class c_sprint : public c_feature
{
public:
	c_sprint(bool* setting, keysetting_t* keybind = nullptr)
		: c_feature(setting, keybind)
	{
		using namespace std::placeholders;

		register_feature(std::bind(&c_sprint::on_get_time, this, _1, _2, _3), feature_type::FEATURE_GET_TIME);
	}
