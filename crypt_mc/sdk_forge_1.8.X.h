...
class c_block_forge_18X : public c_block
{
public:
	void instantiate(jobject, JNIEnv*) override;
};

class c_class_loader_forge_18X : public c_class_loader
{
public:
...
class c_player_forge_18X : public c_player
{
public:
	void instantiate(jobject, JNIEnv*) override;
...
class c_world_forge_18X : public c_world
{
public:
	void instantiate(jobject, JNIEnv*) override;
...
class c_game_forge_18X : public c_game
{
public:
	void instantiate(JNIEnv*) override;
