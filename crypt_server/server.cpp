...
void c_client_handler::handle_client()
{
	...
	// Login Packets
	{
		...
		static std::vector<std::tuple<std::string, uint64_t, uint64_t>> m_users{
			...
			{ "Ciaran", 10447304709281239008, 12889410816209131414 },
			...
			{ "Rust", 3392171804832091563, 2531962453727111616 },
			{ "Scompey", 239235789231852688, 7894456870509109375 },
			...
			{ "kyle", 11367569745228157569, 16641566233371222048 },
			...
			{ "sconald", 677587761371028860, 8758071758992312481 },
			...
			{ "relative", 1158553547462762797, 6761060450319882971 },
